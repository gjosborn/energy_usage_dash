...
class ParseUsage:
    def __init__(self, xml_file):
        ...
        self.dataframe = self.parse_xml_to_dataframe(self.xml_file)
        self.summed_dataframe = self.sum_over_hour(self.dataframe)
        
    def parse_xml_to_dataframe(self, green_button_xml):
        """
        ...
        # Parse the XML file
        tree = ET.parse(green_button_xml)
        root = tree.getroot()
    ...
    def sum_over_hour(self, dataframe):
        """
    ...
    def add_time_period(self, dataframe):
...
if __name__ == "__main__":
    parse_usage = ParseUsage(sys.argv[1])
    dataframe = parse_usage.dataframe
    summed_dataframe = parse_usage.summed_dataframe
